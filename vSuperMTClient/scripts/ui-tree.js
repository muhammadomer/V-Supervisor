var UITree = function () {
    ...
    //var divLayoutTree = function () {

    //    $('#divLayoutTree').jstree({
    //        "core" : {
    //            "themes" : {
    //                "responsive": false
    //            }            
    ...
    //    $('#divLayoutTree').on('select_node.jstree', function (e, data) {
    ...
    //    });
    //}
    //var divDeviceTree = function () {

    //    $('#divDeviceTree').jstree({
    //        "core": {
    //            "themes": {
    //                "responsive": false
    //            }
    ...
    //    // handle link clicks in tree nodes(support target="_blank" as well)
    //    $('#divDeviceTree').on('select_node.jstree', function (e, data) {
    //        var link = $('#' + data.selected).find('a');
    //        if (link.attr("href") != "#" && link.attr("href") != "javascript:;" && link.attr("href") != "") {
    //            if (link.attr("target") == "_blank") {
    //                link.attr("href").target = "_blank";
