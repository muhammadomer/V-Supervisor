<%@ Page Title="" Language="C#" MasterPageFile="~/Supervisor.Master" AutoEventWireup="true" CodeBehind="ACDReports.aspx.cs" Inherits="vSuperMTClient.ACDReports" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
        ...
        <div class="row" style="margin-top: 0%; width: 100%;">
            <div class="row" style="width: 100%;">
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12" style="">
                    <span style="font-size: 26px; color: #999999; margin-left: 0%;">ACD Reports</span>
                </div>
            </div>
            <div class="row" style="padding-top: 10px; padding-bottom: 20px; width: 100%;">
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                    <div style="background-color: white; text-align: left; vertical-align: middle; line-height: 40px;">
                        ...
                        <a href="ACDReports.aspx">
                            <span style="color: #999999;">ACD Reports</span>
                        </a>
                    </div>
                </div>
            </div>
                ...
                <div style="width: 100%; border-style: ridge; border-color: #4d5b69; border-width: 1px 1px 1px 1px;">
                    <div class="row">
                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12" style="line-height: 41px; background-color: #4d5b69;">
                            <span style="font-size: 18px; color: #fffeff;">ACD Reports</span>
                        </div>
                    ...
                    <div class="row" id="Sections" style="display: none;">
                        ...
                        <div class="row SubSection" id="SDateRange" style="width: 100%; padding-top: 0px; padding-bottom: 0px; display: none;">
                         ...
                         <div class="row SubSection" id="Status" style="width: 100%; padding-top: 10px; padding-bottom: 10px; display: none;">
                            ...
                            <div class="=row" style="padding-top: 0px; padding-bottom: 0px;">
                                ...
                                <div class="col-md-9">
                                    <select id="" class="form-control" multiple="multiple" >
                        ...
                        <div class="row SubSection" id="SGroup" style="width: 100%; padding-top: 10px; padding-bottom: 10px; display: none;">
                        ...
                        <div class="row SubSection" id="SDuration" style="width: 100%; padding-bottom: 10px; display: none;">

                            <div class="row" style="width: 100%; border-style: ridge; border-color: #4d5b69; border-width: 1px 1px 1px 1px;">
                                <div class="row">
                                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12" style="text-align: left; vertical-align: middle; line-height: 20px; background-color: #4d5b69;">
                                        <span style="font-size: 12px; color: #fffeff;">Duration</span>
                                    </div>
                                </div>
                                <div class="=row" style="padding-top: 10px; padding-bottom: 50px;">
                                    ...
                                    <div class="col-md-3">
                                        <select id="lstDuration" class="form-control">
                                    ...
                                    <div class="col-md-2">
                                        <input id="txbDuration" type="number" class="form-control" value="0" max="100" min="0" />
                                    </div>
                                </div>
                            </div>
    ...
    <script>
        ...
        $(document).ready(function () {
            $("#ACDReports").addClass("active open");
        });
    </script>
</asp:Content>
